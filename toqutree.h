...
public:
   ...
   * You may want a recursive helper function for this one.
   ...
   void prune(toqutree::Node*&, double&); // test
...
private:
   ...
   */
   ...
   pair<int, int> getSplittingPoint(stats& s, int k);
   double getAvgEntropy(stats& s, int i, int j, int k);
   double getRectEntropy(stats& s, pair<int, int> ul, int k);
